 ...
 */
public struct Unified : IComparable<Unified>, IFormattable
    {
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            return isFloat ? FloatPart.ToString(format, formatProvider)
                : decimal.Parse(IntPart.ToString()).ToString(format, formatProvider);
        }
